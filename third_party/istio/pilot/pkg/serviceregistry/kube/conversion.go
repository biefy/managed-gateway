...
func IsAutoPassthrough(gwLabels map[string]string, l gatewayapi.Listener) bool {
	if l.TLS == nil {
		return false
	}
...
func hasListenerMode(l gatewayapi.Listener, mode string) bool {
...
func GatewaySA(gw *gatewayapi.Gateway) string {
